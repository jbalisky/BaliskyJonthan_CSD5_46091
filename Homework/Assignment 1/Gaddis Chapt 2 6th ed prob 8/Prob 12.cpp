...
//Global const
const int SIZE = 18;//maxim amount of char for a month name
...
int main(int argc, char** argv ) {
	...
	sales = totClld/1.06;//Total sales without tax
	cST = sales*.02;//County sales tax
	sST = sales*.04;//State sales tax
